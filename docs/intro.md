...
| [Proxy contracts](./descriptors/proxies.md) | Protocol teams | How to bind descriptors for proxied contracts — to the implementation address |
...
| [Reviewing pull requests](./registry/reviewing-prs.mdx) | Reviewers & maintainers | The manual review checklist used until the onchain registry exists |
