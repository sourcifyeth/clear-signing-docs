...
Collects the changed descriptor files (`registry/**/eip712-*.json` and `registry/**/calldata-*.json`, excluding test fixtures) and runs the [`erc7730`](https://github.com/LedgerHQ/python-erc7730) linter on them:
